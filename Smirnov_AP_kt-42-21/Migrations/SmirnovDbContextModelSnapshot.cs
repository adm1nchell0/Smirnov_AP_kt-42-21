...
{
    [DbContext(typeof(SmirnovDbContext))]
    partial class SmirnovDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smirnov_AP_kt_42_21.Models.EducationalSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Smirnov_AP_kt_42_21.Models.Professor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Smirnov_AP_kt_42_21.Models.Workload", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Smirnov_AP_kt_42_21.Models.Workload", b =>
                {
                    b.HasOne("Smirnov_AP_kt_42_21.Models.EducationalSubject", "EducationalSubject")
                        .WithMany()
                    ...
                    b.HasOne("Smirnov_AP_kt_42_21.Models.Professor", "Professor")
                        .WithMany()
